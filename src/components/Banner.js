...
const Banner = () => {
  ...
  return (
    <div className='w-full h-auto overflow-x-hidden'>
      ...
      <img src={data[0]} className='w-screen h-full' alt='ImgOne' loading='priority'/>
      <img src={data[1]} className='w-screen h-full' alt='ImgTwo' loading='priority'/>
      <img src={data[2]} className='w-screen h-full' alt='ImgThree' loading='priority'/>
      </div>
